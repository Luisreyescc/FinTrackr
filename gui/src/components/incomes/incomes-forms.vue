    ...
    <div class="form-content scrollbar">
      <form @submit.prevent="submitForm">
        <label>
          ...
          <input
            ...
            :class="{
              ...
              'input-valid': !amountError && income.amount,
            }"
        ...
        <div class="categories-wrapper">
          ...
          ></div>
          <div v-if="showNewCategory" class="new-categories-dialog">
            ...
            <div class="button-group">
              <button @click="cancelNewCategory" class="cancel-categories">
                Cancel
              </button>
              <button
                @click="acceptNewCategory"
                class="accept-categories"
          ...
          <div class="selected-categories">
            <span
              v-for="(categories, index) in income.categories"
              :key="index"
              class="tag"
            >
              {{ categories }}
        ...
        <label>
          ...
          <input
            ...
            :class="{
              ...
              'input-valid': !descriptionError && income.description,
            }"
        ...
        <label>
          ...
          <input
            ...
            :class="{
              ...
              'input-valid': !dateError && income.date,
            }"
          />
        </label>
  ...
  methods: {
    submitForm() {
      ...
      if (isAmountValid && isDescriptionValid && isDateValid) {
        this.$emit("submitForm", {
          ...this.income,
          category: this.income.categories,
        });
        this.$emit("closeForm");
        this.resetForm();
      }
    ...
    async acceptNewCategory() {
      if (this.newCategory.trim()) {
        ...
        this.income.categories.push(this.newCategory);
        this.showNewCategory = false;
        this.newCategory = "";
        this.dropdownOpen = false;
      }
