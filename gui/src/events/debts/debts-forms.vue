...
export default {
  ...
  data() {
    return {
      debt: {
        ...
        categories: [],
        date: "",
        debtor_name: "", // Nuevo campo agregado para debtor_name
      },
      amountError: "",
      descriptionError: "",
      dateError: "",
  ...
  methods: {
    async submitForm() {
      ...
      const isDebtorNameValid = this.validateTextField("debtor_name");
      ...
      if (
        ...
        try {
          ...
          // Enviar los datos de la deuda al backend
    ...
    validateTextField(field) {
      ...
      if (this.debt[field].length > 255) {
        this[`${field}Error`] = `Exceeded the maximum character limit of 255`;
        return false;
      }
      return true;
    },
