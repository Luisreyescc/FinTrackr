    ...
    <form class="forms-content scrollbar" @submit.prevent="submitForm">
      ...
      <div class="categories-wrapper">
        ...
        <div v-if="showNewCategory" class="new-category-dialog">
          ...
          <input type="text" v-model="newCategory" placeholder="New source" :maxlength="18"/>
      ...
      <div class="icons-wrapper">
        <IconDropdown :iconOptions="iconOptions" :currentIcon="income.icon" @iconSelected="applyIcon"/>
