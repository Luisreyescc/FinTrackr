    ...
    <div class="popup-content">
      <form class="forms-content scrollbar" @submit.prevent="submitEdit">
        ...
        <div class="icons-wrapper">
          <IconDropdown :iconOptions="iconOptions" :currentIcon="editExpense.icon" @iconSelected="applyIcon"/>
...
export default {
  ...
  data() {
    return {
      isEditing: false,
      editExpense: { ...this.expense, categories: this.expense.categories || [] },
      amountError: "",
      descriptionError: "",
      dateError: "",
      categoryOptions: [],
  ...
  methods: {
    ...
    submitEdit() {
      ...
      if (isAmountValid && isDescriptionValid && isDateValid) {
        const iconString = Array.isArray(this.editExpense.icon)
          ? this.editExpense.icon.join(" ")
          : this.editExpense.icon;
        const expenseData = {
          ...this.editExpense,
