  ...
  <div class="edit-form">
    ...
    <div class="user_name-container">
      ...
      <input
        ...
        :class="{ 'input-error': user_nameError, 'padded-input': true }"
        @input="validateuser_name"
      />
    </div>
    <span v-if="user_nameError" class="error-message">{{
      user_nameError
    }}</span>
    ...
    <div v-if="showPasswordFields">
      ...
      <div class="password-container">
        ...
        >
          <span
            :class="{ 'gg-eye': true, 'gg-eye-alt': showNewPassword }"
          ></span>
        </button>
      </div>
...
export default {
  ...
  methods: {
    validateuser_name() {
      this.user_nameError = this.formData.user_name
        ? this.formData.user_name.length >= 3
          ? ""
    ...
    validatePhone() {
      this.phoneError =
        this.formData.phone && !/^\d+$/.test(this.formData.phone)
